module CosmosProjector.Program

open Equinox.Cosmos
open Propulsion.Cosmos
open Serilog
open System
open HybridProjector
...
let start (args : CmdParser.Arguments) =
    ...
    let project (_stream, span: Propulsion.Streams.StreamSpan<_>) : Async<unit> = async {
        return! CSharpProjector.Test(_stream,span) |> Async.AwaitTask
    }
